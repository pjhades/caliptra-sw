...
impl CommandId {
    ...
    pub const OCP_LOCK_MIX_MPK: Self = Self(0x4D4D_504B); // "MMPK"
    ...
    pub const OCP_LOCK_GET_HPKE_PUB_KEY: Self = Self(0x4748_504B); // "GHPK"
...
pub enum MailboxResp {
    ...
    OcpLockEndorseHpkePubKey(OcpLockGetHpkePubKeyResp),
    OcpLockInitializeMekSecret(OcpLockInitializeMekSecretResp),
    OcpLockMixMpk(OcpLockMixMpkResp),
...
impl MailboxResp {
    pub fn as_bytes(&self) -> CaliptraResult<&[u8]> {
        match self {
            ...
            MailboxResp::OcpLockMixMpk(resp) => Ok(resp.as_bytes()),
    ...
    pub fn as_mut_bytes(&mut self) -> CaliptraResult<&mut [u8]> {
        match self {
            ...
            MailboxResp::OcpLockMixMpk(resp) => Ok(resp.as_mut_bytes()),
...
pub enum MailboxReq {
    ...
    OcpLockGetHpkePubKey(OcpLockGetHpkePubKeyReq),
    OcpLockInitializeMekSecret(OcpLockInitializeMekSecretReq),
    OcpLockMixMpk(OcpLockMixMpkReq),
...
impl MailboxReq {
    pub fn as_bytes(&self) -> CaliptraResult<&[u8]> {
        match self {
            ...
            MailboxReq::OcpLockGetHpkePubKey(req) => Ok(req.as_bytes()),
            MailboxReq::OcpLockInitializeMekSecret(req) => Ok(req.as_bytes()),
            MailboxReq::OcpLockMixMpk(req) => Ok(req.as_bytes()),
    ...
    pub fn as_mut_bytes(&mut self) -> CaliptraResult<&mut [u8]> {
        match self {
            ...
            MailboxReq::OcpLockMixMpk(req) => Ok(req.as_mut_bytes()),
            ...
            MailboxReq::OcpLockGetHpkePubKey(req) => Ok(req.as_mut_bytes()),
    ...
    pub fn cmd_code(&self) -> CommandId {
        match self {
            ...
            MailboxReq::OcpLockMixMpk(_) => CommandId::OCP_LOCK_MIX_MPK,
            ...
            MailboxReq::OcpLockGetHpkePubKey(_) => CommandId::OCP_LOCK_GET_HPKE_PUB_KEY,
...
#[repr(C)]
#[derive(Debug, Default, IntoBytes, FromBytes, Immutable, KnownLayout, PartialEq, Eq)]
pub struct OcpLockMixMpkReq {
    pub hdr: MailboxReqHeader,
    pub reserved: u32,
    pub enabled_mpk: WrappedKey,
}
impl Request for OcpLockMixMpkReq {
    const ID: CommandId = CommandId::OCP_LOCK_MIX_MPK;
    type Resp = OcpLockMixMpkResp;
}

#[repr(C)]
#[derive(Debug, Default, IntoBytes, FromBytes, Immutable, KnownLayout, PartialEq, Eq)]
pub struct OcpLockMixMpkResp {
    pub hdr: MailboxRespHeader,
    pub reserved: u32,
}
impl Response for OcpLockMixMpkResp {}
...
pub struct WrappedKey {
    ...
    pub ciphertext_and_auth_tag: [u8; 80],
}
...
// OCP_LOCK_GET_HPKE_PUB_KEY

#[repr(C)]
#[derive(Debug, Default, IntoBytes, FromBytes, Immutable, KnownLayout, PartialEq, Eq)]
pub struct OcpLockGetHpkePubKeyReq {
    pub hdr: MailboxReqHeader,
    pub reserved: u32,
    pub hpke_handle: u32,
}
impl Request for OcpLockGetHpkePubKeyReq {
    ...
    type Resp = OcpLockGetHpkePubKeyResp;
}

#[repr(C)]
#[derive(Debug, IntoBytes, FromBytes, Immutable, KnownLayout, PartialEq, Eq)]
pub struct OcpLockGetHpkePubKeyResp {
    pub hdr: MailboxRespHeader,
    pub reserved: u32,
    pub pub_key_len: u32,
...
impl Default for OcpLockGetHpkePubKeyResp {
    fn default() -> Self {
        Self {
            hdr: MailboxRespHeader::default(),
            reserved: 0,
...
impl Response for OcpLockGetHpkePubKeyResp {}
...
#[repr(C)]
#[derive(Debug, Default, IntoBytes, FromBytes, Immutable, KnownLayout, PartialEq, Eq)]
pub struct OcpLockEnableMpkReq {
    pub hdr: MailboxReqHeader,
    pub reserved: u32,
    pub sek: [u8; 32],
    pub sealed_access_key: SealedAccessKey,
...
impl Request for OcpLockEnableMpkReq {
    const ID: CommandId = CommandId::OCP_LOCK_ENABLE_MPK;
    type Resp = OcpLockEnableMpkResp;
}

#[repr(C)]
#[derive(Debug, Default, IntoBytes, FromBytes, Immutable, KnownLayout, PartialEq, Eq)]
pub struct OcpLockEnableMpkResp {
    pub hdr: MailboxRespHeader,
    pub reserved: u32,
    pub enabled_mpk: WrappedKey,
}
...
impl Request for OcpLockLoadMekReq {
    const ID: CommandId = CommandId::OCP_LOCK_LOAD_MEK;
    type Resp = OcpLockLoadMekResp;
}

#[repr(C)]
#[derive(Debug, Default, IntoBytes, FromBytes, Immutable, KnownLayout, PartialEq, Eq)]
pub struct OcpLockLoadMekResp {
    pub hdr: MailboxRespHeader,
    pub reserved: u32,
}
